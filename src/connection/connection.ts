...
export async function connect(roomName: string, options: any = {}) {
    console.log("connect-flow","connect",roomName,options)
    disconnect()
    ...
    console.log("connect-flow","connect",roomName,options,"to",ENDPOINT)
...
export function disconnect(_consent?:boolean) {
    console.log("disconnect",_consent,GAME_STATE.gameRoom)
    ...
    if (GAME_STATE.gameRoom !== null && GAME_STATE.gameRoom !== undefined) {
        ...
        console.log("disconnect","calling leave now")
